...
public class UserController {
    ...
    public String registerUser(@RequestBody AuthenticationRequest authenticationRequest) {
        ...
        myUser.setEmail(authenticationRequest.getEmail());
        myUser.setUsername(authenticationRequest.getEmail());
        myUser.setPassword(bCryptPasswordEncoder.encode(authenticationRequest.getPassword()));
